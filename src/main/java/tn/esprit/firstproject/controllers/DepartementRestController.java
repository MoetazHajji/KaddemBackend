...
public class DepartementRestController {
    ...
    @GetMapping("/getDepByUni/{idUniversite}")
    public List<Departement> retreiveDepartmentsByUniversite(@PathVariable("idUniversite") Integer idUniversite){
        return iDepartementServices.retreiveDepartmentsByUnivesite(idUniversite);
    }
